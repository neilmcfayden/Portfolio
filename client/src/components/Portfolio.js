      ...
      <div className="portfolio-container">
        <div className="project">
          ...
          <div className = "project-links">
            <button type="button" className="map-button" onClick={project1Link}>Open Project</button>
            <button type="button" className="map-button" onClick={project1Git}>GitHub</button>
          </div>

          <p>Individual project (9 days). I built the popular mastermind game using the HTML, CSS and JavaScript that we had learned during the first 3 weeks of the course. 
        ...
        <div className="project">
          ...
          <div className = "project-links">
            <button type="button" className="map-button" onClick={project2Link}>Open Project</button>
            <button type="button" className="map-button" onClick={project2Git}>GitHub</button>
          </div>
          <p>
        ...
        <div className="project">
          <h2>SpaceBook</h2>
          <div className = "project-links">
          <button type="button" className="map-button" onClick={project3Link}>Open Project</button>
          <button type="button" className="map-button" onClick={project3Git}>GitHub</button>
          </div>
          <p>
        ...
        <div className="project">
          ...
          <div className = "project-links">
            <button type="button" className="map-button" onClick={project4Link}>Open Project</button>
            <button type="button" className="map-button" onClick={project4Git}>GitHub</button>
            </div>
          <p>
